...
export default function Footer({
  ...
  return (
    <footer
      id="contact"
      className="bg-[#141b27] text-slate-300 pt-16 pb-0 relative overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 pb-12 border-b border-slate-800/80">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-xs sm:text-sm text-slate-400">
              ...
              <li>
                <Link href="/kidography" className="hover:text-purple-400 transition-colors">
                  Kidography
                </Link>
              </li>
              <li>
                <Link href="/films" className="hover:text-purple-400 transition-colors">
                  Films
                </Link>
              </li>
              <li>
          ...
          <div className="flex flex-col gap-4 text-xs sm:text-sm">
            ...
            {/* Email */}
            <a
              href="mailto:orchidphotography.official@gmail.com"
